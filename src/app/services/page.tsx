          ...
          <div className="grid grid-cols-1 gap-y-12 sm:gap-y-16 lg:grid-cols-3 lg:gap-x-8">
            {services.map((service) => (
              <div key={service.name} className="flex flex-col">
                <h3 className="text-base sm:text-lg font-semibold leading-7 sm:leading-8 tracking-tight text-gray-900">{service.name}</h3>
                <p className="mt-3 sm:mt-4 text-sm sm:text-base leading-6 sm:leading-7 text-gray-600">{service.description}</p>
                <ul role="list" className="mt-6 sm:mt-8 space-y-2 sm:space-y-3">
      ...
      <div className="bg-gray-50 py-16 sm:py-24">
        <Container>
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Simple, Transparent Pricing</h2>
            <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-gray-600">
              One comprehensive package that includes everything you need to grow your med spa.
            </p>
          </div>

          <div className="mx-auto mt-12 sm:mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            <div className="p-6 sm:p-8 sm:p-10 lg:flex-auto">
              <h3 className="text-xl sm:text-2xl font-bold tracking-tight text-gray-900">All-Inclusive Marketing Package</h3>
              ...
              <ul role="list" className="mt-6 sm:mt-8 grid grid-cols-1 gap-3 sm:gap-4 text-sm leading-6 text-gray-600 sm:grid-cols-2 sm:gap-6">
            ...
            <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
              <div className="rounded-2xl bg-gray-50 py-8 sm:py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                <div className="mx-auto max-w-xs px-6 sm:px-8">
                  <p className="text-sm sm:text-base font-semibold text-gray-600">Monthly Investment</p>
                  <p className="mt-4 sm:mt-6 flex items-baseline justify-center gap-x-2">
                    <span className="text-4xl sm:text-5xl font-bold tracking-tight text-gray-900">$2,500</span>
                    <span className="text-sm font-semibold leading-6 tracking-wide text-gray-600">/month</span>
                  </p>
                  <p className="mt-4 sm:mt-6 text-xs leading-5 text-gray-600">
                    No long-term contracts. Cancel anytime.
                  </p>
                  <Button href="/contact" className="mt-8 sm:mt-10 w-full" size="lg">
          ...
          {/* Performance Guarantee */}
          <div className="mt-16 sm:mt-24 rounded-3xl bg-white p-6 sm:p-8 shadow-lg sm:p-10">
            <h3 className="text-xl sm:text-2xl font-bold tracking-tight text-gray-900">Our Performance Guarantee</h3>
            <p className="mt-4 sm:mt-6 text-sm sm:text-base leading-6 sm:leading-7 text-gray-600">
