...
const nextConfig = {
  ...
  // Enhanced headers for better caching, security, and performance
  async headers() {
    return [
      {
        source: '/(.*)',
      ...
      {
        source: '/results-(.*).(jpg|jpeg|png|webp|avif)',
        headers: [
          {
            key: 'Cache-Control',
            value: 'public, max-age=31536000, immutable',
  ...
  // Enhanced webpack optimizations for better performance
